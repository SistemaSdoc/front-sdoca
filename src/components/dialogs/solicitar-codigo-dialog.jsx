...
export default function SolicitarCodigoDialog({ documentoId, showDialog, onOpenChange }) {
    ...
    <AlertDialog open={showDialog} onOpenChange={onOpenChange && enviarCodigoMutation.isPending}>
      <AlertDialogContent className="md:max-w-md">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            {etapa === 1
              ? "Escolha o método para receber o código de confirmação para a assinatura do documento."
